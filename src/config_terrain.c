...
static const struct NamedCommand terrain_flags[] = {
    ...
    {"IS_ROOM",           SlbAtFlg_IsRoom        },
    {"UNEXPLORED",        SlbAtFlg_Unexplored    },
    {"DIGGABLE",          SlbAtFlg_Digable       },
    {"BLOCKING",          SlbAtFlg_Blocking      },
    {"FILLED",            SlbAtFlg_Filled        },
    {"IS_DOOR",           SlbAtFlg_IsDoor        },
    {"TAGGED_VALUABLE",   SlbAtFlg_TaggedValuable},
    {NULL,                0},
};
